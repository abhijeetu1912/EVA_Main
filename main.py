...
if __name__ == '__main__':
    ...
    parser.add_argument('--end_lr', default = 4.0, type = float, help = 'End LR for LR Finder')
    ...
    parser.add_argument('--boundary', default = 4.0, type = float, help = 'Search space to limit LR range for LR Finder')
